...
import { ThumsComponent } from '../';

describe('ThumsComponent', () => {
  let component: ThumsComponent;
  let fixture: ComponentFixture<ThumsComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ThumsComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ThumsComponent);
